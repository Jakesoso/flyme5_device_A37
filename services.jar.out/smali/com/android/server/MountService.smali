...
.method private handleSystemReady()V
    ...
    new-instance v18, Lcom/android/server/MountService$1;
...
.method private updateDefaultpath()V
    ...
    const-string v6, "show sdcard_default_path_change toast"
...
.method public encryptStorage(ILjava/lang/String;)I
    ...
    const-string v11, "password cannot be empty"
    ...
    iget-object v10, v0, Lcom/android/server/MountService;->mContext:Landroid/content/Context;

    const-string v11, "android.permission.CRYPT_KEEPER"

    const-string v12, "no permission to access the crypt keeper"
    ...
    const-string v11, "encrypting storage..."

    invoke-static {v10, v11}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 3890
    const-string v10, "ro.mtk_shared_sdcard"
    ...
    .line 3892
    .local v9, "volumeEmulated":Landroid/os/storage/StorageVolume;
    move-object/from16 v0, p0

    iget-object v11, v0, Lcom/android/server/MountService;->mVolumesLock:Ljava/lang/Object;
    ...
    iget-object v10, v0, Lcom/android/server/MountService;->mVolumes:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v10, v9, v11}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    .line 3902
    .local v7, "tryCount":I
    const-string v6, "debug.mtklog.netlog.Running"

    .line 3903
    .local v6, "netlog":Ljava/lang/String;
    const-string v5, "debug.mdlogger.Running"

    .line 3904
    .local v5, "mdlogger":Ljava/lang/String;
    const-string v2, "debug.MB.running"

    .line 3907
    .local v2, "MBlog":Ljava/lang/String;
    :goto_0
    const-string v10, "debug.mtklog.netlog.Running"
    ...
    const-string v10, "debug.mdlogger.Running"
    ...
    const-string v10, "debug.MB.running"
    ...
    const-string v11, "try count = 60, break"
    ...
    .line 3929
    .end local v2    # "MBlog":Ljava/lang/String;
    .end local v4    # "i$":Ljava/util/Iterator;
    .end local v5    # "mdlogger":Ljava/lang/String;
    .end local v6    # "netlog":Ljava/lang/String;
    .end local v7    # "tryCount":I
    .end local v9    # "volumeEmulated":Landroid/os/storage/StorageVolume;
    :cond_5
    :goto_1
    :try_start_2
    move-object/from16 v0, p0

    iget-object v10, v0, Lcom/android/server/MountService;->mConnector:Lcom/android/server/NativeDaemonConnector;

    const-string v11, "cryptfs"
    ...
    const-string v14, "enablecrypto"

    aput-object v14, v12, v13

    const/4 v13, 0x1

    const-string v14, "inplace"

    aput-object v14, v12, v13

    const/4 v13, 0x2

    sget-object v14, Lcom/android/server/MountService;->CRYPTO_TYPES:[Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lcom/android/server/MountService;->toHex(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 3899
    .restart local v9    # "volumeEmulated":Landroid/os/storage/StorageVolume;
    :catchall_0
    move-exception v10
    ...
    .line 3913
    .restart local v2    # "MBlog":Ljava/lang/String;
    .restart local v4    # "i$":Ljava/util/Iterator;
    .restart local v5    # "mdlogger":Ljava/lang/String;
    .restart local v6    # "netlog":Ljava/lang/String;
    ...
    const-string v12, "debug.mtklog.netlog.Running="
    ...
    const-string v12, "debug.mdlogger.Running="
    ...
    const-string v12, "debug.MB.running="
...
.method public setField(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "setField caught NativeDaemonConnectorException "
