...
.method public varargs addInts(I[I)V
    .locals 4
    .param p1, "tag"    # I
    .param p2, "values"    # [I
    ...
    .line 70
    .local v3, "value":I
    invoke-virtual {p0, p1, v3}, Landroid/security/keymaster/KeymasterArguments;->addInt(II)V
...
.method public addLong(IJ)V
    ...
    invoke-direct {v1, p1, p2, p3}, Landroid/security/keymaster/KeymasterLongArgument;-><init>(IJ)V
...
.method public varargs addLongs(I[J)V
    .locals 6
    .param p1, "tag"    # I
    .param p2, "values"    # [J
    ...
    .line 76
    .local v4, "value":J
    invoke-virtual {p0, p1, v4, v5}, Landroid/security/keymaster/KeymasterArguments;->addLong(IJ)V
...
.method public getInt(II)I
    ...
    const-string v3, "Tag is not an int type: "
    ...
    const-string v3, "Repeatable tags must use getInts: "
    ...
    .end local v0    # "arg":Landroid/security/keymaster/KeymasterArgument;
    iget p2, v0, Landroid/security/keymaster/KeymasterIntArgument;->value:I
