...
.method static synthetic access$000(Lcom/mediatek/widget/DefaultAccountPickerDialog;)I
    .locals 1
    .param p0, "x0"    # Lcom/mediatek/widget/DefaultAccountPickerDialog;
...
.method static synthetic access$002(Lcom/mediatek/widget/DefaultAccountPickerDialog;I)I
    .locals 0
    .param p0, "x0"    # Lcom/mediatek/widget/DefaultAccountPickerDialog;
    .param p1, "x1"    # I
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    const-string v4, "AccountInfoList"
    ...
    .line 82
    const-string v3, "DefaultAccountPickerDialog"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "onCreateDialog get data form args : "
    ...
    new-instance v4, Lcom/mediatek/widget/DefaultAccountPickerDialog$2;

    invoke-direct {v4, p0}, Lcom/mediatek/widget/DefaultAccountPickerDialog$2;-><init>(Lcom/mediatek/widget/DefaultAccountPickerDialog;)V
    ...
    new-instance v4, Lcom/mediatek/widget/DefaultAccountPickerDialog$3;

    invoke-direct {v4, p0, v0}, Lcom/mediatek/widget/DefaultAccountPickerDialog$3;-><init>(Lcom/mediatek/widget/DefaultAccountPickerDialog;Lcom/mediatek/widget/DefaultAccountPickerAdapter;)V
...
.method public setData(Ljava/util/List;)Lcom/mediatek/widget/DefaultAccountPickerDialog;
    ...
    .line 64
    .local v7, "accountInfo":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;>;"
    ...
    check-cast v8, Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;

    .line 65
    .local v8, "ai":Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;
    new-instance v0, Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;

    invoke-virtual {v8}, Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;->getIconId()I

    move-result v1

    invoke-virtual {v8}, Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;->getIcon()Landroid/graphics/Bitmap;

    move-result-object v2

    invoke-virtual {v8}, Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;->getLabel()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v8}, Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;->getNumber()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v8}, Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;->getIntent()Landroid/content/Intent;

    move-result-object v5

    invoke-virtual {v8}, Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;->isActive()Z
    ...
    .line 68
    .end local v8    # "ai":Lcom/mediatek/widget/CustomAccountRemoteViews$AccountInfo;
    :cond_0
    const-string v0, "AccountInfoList"

    invoke-virtual {v9, v0, v7}, Landroid/os/Bundle;->putParcelableArrayList(Ljava/lang/String;Ljava/util/ArrayList;)V

    .line 69
    invoke-virtual {p0, v9}, Lcom/mediatek/widget/DefaultAccountPickerDialog;->setArguments(Landroid/os/Bundle;)V
