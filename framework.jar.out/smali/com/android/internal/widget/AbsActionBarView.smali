...
.field protected mOptionMenuPresenter:Lcom/color/widget/ColorOptionMenuPresenter;
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_FIELD:Landroid/annotation/OppoHook$OppoHookType;
        note = "JianHui.Yu@Plf.SDK, 2015-06-17 : Add for SplitMenu"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
.end field

.field protected mOptionMenuView:Lcom/color/widget/ColorOptionMenuView;
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_FIELD:Landroid/annotation/OppoHook$OppoHookType;
        note = "Changwei.Li@Plf.SDK, 2015-05-28 : Add for SplitMenu"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 314
    iput-object v2, p0, Lcom/android/internal/widget/AbsActionBarView;->mOptionMenuView:Lcom/color/widget/ColorOptionMenuView;

    .line 320
    iput-object v2, p0, Lcom/android/internal/widget/AbsActionBarView;->mOptionMenuPresenter:Lcom/color/widget/ColorOptionMenuPresenter;
