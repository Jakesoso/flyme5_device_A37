...
.method protected dispatchMessageRadioSpecific(Lcom/android/internal/telephony/SmsMessageBase;)I
    ...
    invoke-virtual {v2, v6}, Lcom/android/internal/telephony/CellBroadcastHandler;->dispatchSmsMessage(Ljava/lang/Object;)V

    goto :goto_0

    .line 129
    .end local v6    # "cbMessage":Landroid/telephony/SmsCbMessage;
    .end local v10    # "isBroadcastType":Z
    :cond_2
    const/4 v10, 0x0
    ...
    .restart local v10    # "isBroadcastType":Z
    :cond_3
    ...
    .line 158
    :sswitch_0
    invoke-direct {p0, v12}, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandler;->handleVoicemailTeleservice(Lcom/android/internal/telephony/cdma/SmsMessage;)V
    ...
    invoke-virtual {v2, v12}, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->sendStatusReportMessage(Lcom/android/internal/telephony/cdma/SmsMessage;)V
    ...
    invoke-virtual {v2, v12}, Lcom/android/internal/telephony/cdma/CdmaServiceCategoryProgramHandler;->dispatchSmsMessage(Ljava/lang/Object;)V

    goto :goto_0

    .line 182
    :sswitch_3
    const-string v2, "ctsmsreg teleservice 0xFDED"
    ...
    invoke-direct {v9, v2}, Lcom/android/internal/util/BitwiseInputStream;-><init>([B)V
    ...
    invoke-virtual {v9, v2}, Lcom/android/internal/util/BitwiseInputStream;->read(I)I
    ...
    const-string v2, "process wap pdu fail"
    ...
    .line 230
    :cond_b
    const-string v2, "Received a empty WAPPUSH . Discard."
    ...
    .line 233
    :cond_c
    iget v2, v12, Lcom/android/internal/telephony/cdma/SmsMessage;->mMessageRef:I

    invoke-virtual {v12}, Lcom/android/internal/telephony/cdma/SmsMessage;->getOriginatingAddress()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v12}, Lcom/android/internal/telephony/cdma/SmsMessage;->getTimestampMillis()J
