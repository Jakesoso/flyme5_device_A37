...
.method endFling()V
    ...
    const-string v6, "endFling+: mScrollY = "
    ...
    const-string v7, "endFling"

    invoke-direct {v6, v7}, Ljava/lang/Throwable;-><init>(Ljava/lang/String;)V

    invoke-static {v4, v5, v6}, Lcom/mediatek/xlog/Xlog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-virtual {v4, p0}, Landroid/widget/AbsListView;->removeCallbacks(Ljava/lang/Runnable;)Z

    .line 5010
    iget-object v4, p0, Landroid/widget/AbsListView$FlingRunnable;->this$0:Landroid/widget/AbsListView;

    iget-object v5, p0, Landroid/widget/AbsListView$FlingRunnable;->mCheckFlywheel:Ljava/lang/Runnable;

    invoke-virtual {v4, v5}, Landroid/widget/AbsListView;->removeCallbacks(Ljava/lang/Runnable;)Z

    .line 5012
    iget-object v4, p0, Landroid/widget/AbsListView$FlingRunnable;->this$0:Landroid/widget/AbsListView;

    invoke-virtual {v4, v9}, Landroid/widget/AbsListView;->reportScrollStateChange(I)V

    .line 5013
    iget-object v4, p0, Landroid/widget/AbsListView$FlingRunnable;->this$0:Landroid/widget/AbsListView;

    # invokes: Landroid/widget/AbsListView;->clearScrollingCache()V
    invoke-static {v4}, Landroid/widget/AbsListView;->access$3600(Landroid/widget/AbsListView;)V
    ...
    # getter for: Landroid/widget/AbsListView;->mScrollY:I
    invoke-static {v6}, Landroid/widget/AbsListView;->access$3700(Landroid/widget/AbsListView;)I
    ...
    invoke-static {v4}, Landroid/widget/AbsListView;->access$2200(Landroid/widget/AbsListView;)Landroid/os/StrictMode$Span;
    ...
    invoke-static {v4, v8}, Landroid/widget/AbsListView;->access$2202(Landroid/widget/AbsListView;Landroid/os/StrictMode$Span;)Landroid/os/StrictMode$Span;

    .line 5027
    :cond_0
    sget-boolean v4, Landroid/widget/AbsListView;->isEnableEndFlingProtect:Z
    ...
    .line 5029
    .local v0, "curTime":J
    sget-wide v4, Landroid/widget/AbsListView;->lastEndFlingTime:J
    ...
    .line 5030
    sget-wide v4, Landroid/widget/AbsListView;->constantEndFlingNum:J
    ...
    sget-object v5, Landroid/widget/AbsListView;->LONG_FORMAT:[I

    invoke-static {v4, v5, v8, v2, v8}, Landroid/os/Process;->readProcFile(Ljava/lang/String;[I[Ljava/lang/String;[J[F)Z
    ...
    :cond_1
    :goto_1
    sput-wide v0, Landroid/widget/AbsListView;->lastEndFlingTime:J
...
.method public run()V
    ...
    # getter for: Landroid/widget/AbsListView;->mIsOppoStyle:Z
    invoke-static {v2}, Landroid/widget/AbsListView;->access$4600(Landroid/widget/AbsListView;)Z
    ...
    # getter for: Landroid/widget/AbsListView;->mScrollY:I
    invoke-static {v2}, Landroid/widget/AbsListView;->access$4700(Landroid/widget/AbsListView;)I
    ...
    # invokes: Landroid/widget/AbsListView;->overScrollBy(IIIIIIIIZ)Z
    invoke-static/range {v5 .. v14}, Landroid/widget/AbsListView;->access$4800(Landroid/widget/AbsListView;IIIIIIIIZ)Z
