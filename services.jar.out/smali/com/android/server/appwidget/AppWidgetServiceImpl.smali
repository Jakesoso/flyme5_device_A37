...
.method public getEnabledWidgets()Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 907
    .local v1, "enabledWidgets":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    iget-object v6, p0, Lcom/android/server/appwidget/AppWidgetServiceImpl;->mLock:Ljava/lang/Object;
    ...
    .line 911
    .end local v1    # "enabledWidgets":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    .local v2, "enabledWidgets":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    const/4 v3, 0x0
    ...
    .line 919
    .end local v2    # "enabledWidgets":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    .end local v3    # "i":I
    .restart local v1    # "enabledWidgets":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    :cond_2
    :try_start_2
    monitor-exit v6
    ...
    .end local v1    # "enabledWidgets":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    .restart local v0    # "N":I
    .restart local v2    # "enabledWidgets":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
