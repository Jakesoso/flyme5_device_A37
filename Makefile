...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreRemoteService \
                     FusedLocation PrintSpooler SharedStorageBackup  ExternalStorageProvider InputDevices \
                     ProxyHandler Shell DefaultContainerService Nfc YGPS Stk1
...
#-----------------------------------------------------------------------------
vendor_modify_jars := android.policy com.gsma.services.nfc framework mediatek-framework mediatek-telephony-common oppo-framework services telephony-common wifi-service
...
#-----------------------------------------------------------------------------
board_saved_files := lib/libwebviewchromium.so lib64/libwebviewchromium.so media/bootanimation.zip bin/bootanimation
...
override_property += \
    ro.flyme.romer=流浪人群中\
    ro.product.model_romer=OPPO-A37_流浪人群中
