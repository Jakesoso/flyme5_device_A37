...
.field static final LAUNCH_BOOST_DELAY_MSG:I = 0x44c
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/ActivityStack;->mHyp:Lcom/oppo/hypnus/Hypnus;
...
.method constructor <init>(Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;)V
    ...
    .line 278
    iput-boolean v2, p0, Lcom/android/server/am/ActivityStack;->mScreenShotDisabled:Z
...
.method private completePauseLocked(Z)V
    ...
    const-string v8, "Delay resumeKeyDispatchingLocked() to avoid deadlock."
    ...
    iget-boolean v7, v7, Lcom/android/server/am/ActivityManagerService;->mIgnoreSleepCheckLater:Z
    ...
    const-string v8, "completePauseLocked, mIgnoreSleepCheckLater, do not care."
    ...
    const-string v8, "resumeNext, mIgnoreSleepCheckLater, do not care."
...
.method private insertTaskAtTop(Lcom/android/server/am/TaskRecord;)V
    ...
    .line 2398
    .local v4, "lastStack":Lcom/android/server/am/ActivityStack;
    ...
    .line 2401
    .local v3, "fromHome":Z
    sget-boolean v10, Lcom/android/server/am/ActivityManagerService;->DEBUG_TASK_RETURNTO:Z
    ...
    .line 2406
    .local v9, "top":Lcom/android/server/am/TaskRecord;
    const-string v10, "ActivityManager"
    ...
    iget v12, v9, Lcom/android/server/am/TaskRecord;->taskType:I
    ...
    .line 2416
    .end local v9    # "top":Lcom/android/server/am/TaskRecord;
    :cond_0
    invoke-static {}, Lcom/mediatek/multiwindow/MultiWindowProxy;->isFeatureSupport()Z
    ...
    iput-boolean v10, p1, Lcom/android/server/am/TaskRecord;->mFloatingBackIsHome:Z
    ...
    invoke-virtual {v1, v10}, Lcom/android/server/am/ActivityStack;->topRunningNonDelayedActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    .line 2440
    .end local v1    # "appStack":Lcom/android/server/am/ActivityStack;
    .end local v5    # "next":Lcom/android/server/am/ActivityRecord;
    :cond_3
    :goto_0
    iget-boolean v10, p1, Lcom/android/server/am/TaskRecord;->mFloatingBackIsHome:Z
    ...
    sget-boolean v10, Lcom/android/server/am/ActivityManagerService;->DEBUG_TASKS:Z

    if-eqz v10, :cond_6

    const-string v10, "ActivityManager"

    const-string v11, "insertTaskAtTop:move a OnTopOfHome task to top when fromHome is false."
    ...
    const-string v12, "insertTaskAtTop:adjust mOnTopOfHome of the task:"
    ...
    const-string v12, ", oldOnTopOfHomeValue:"
    ...
    invoke-virtual {v0, v10}, Lcom/android/server/am/TaskRecord;->setTaskToReturnTo(I)V
    ...
    .end local v4    # "lastStack":Lcom/android/server/am/ActivityStack;
    .end local v6    # "oldTaskToReturnTo":I
    :cond_8
    :goto_2
    sget-boolean v10, Lcom/android/server/am/ActivityManagerService;->DEBUG_TASKS:Z
    ...
    const-string v12, "befor insertTaskAtTop:mTaskHistory."
    ...
    invoke-direct {p0, v10}, Lcom/android/server/am/ActivityStack;->isCurrentProfileLocked(I)Z
    ...
    invoke-virtual {v10, v8, p1}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V
    ...
    const-string v12, "after insertTaskAtTop:mTaskHistory."
    ...
    invoke-virtual {v10, v11}, Lcom/mediatek/multiwindow/MultiWindowProxy;->taskAdded(I)V
    ...
    .restart local v1    # "appStack":Lcom/android/server/am/ActivityStack;
    .restart local v3    # "fromHome":Z
    .restart local v4    # "lastStack":Lcom/android/server/am/ActivityStack;
    ...
    .end local v1    # "appStack":Lcom/android/server/am/ActivityStack;
    .end local v5    # "next":Lcom/android/server/am/ActivityRecord;
    .restart local v6    # "oldTaskToReturnTo":I
    :cond_10
    invoke-virtual {v4}, Lcom/android/server/am/ActivityStack;->topTask()Lcom/android/server/am/TaskRecord;

    move-result-object v10

    iget v10, v10, Lcom/android/server/am/TaskRecord;->taskType:I
...
.method private perfBoostResume()V
    ...
    .line 5208
    sget-boolean v0, Lcom/android/server/am/ActivityManagerService;->DEBUG_PERFSRV:Z
    ...
    const-string v1, "boostEnableTimeoutMs(1) cross app"
    ...
    const-string v1, "PerfService is not ready!"
...
.method final destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZLjava/lang/String;)Z
    ...
    sget-object v10, Lcom/android/server/am/IActivityStateNotifier$ActivityState;->Destroyed:Lcom/android/server/am/IActivityStateNotifier$ActivityState;

    invoke-virtual {v5, v7, v8, v9, v10}, Lcom/android/server/am/ActivityManagerService;->notifyActivityState(Ljava/lang/String;ILjava/lang/String;Lcom/android/server/am/IActivityStateNotifier$ActivityState;)V
    ...
    invoke-virtual {v5, v7, v6, v11}, Lcom/android/server/am/ActivityManagerService;->updateLruProcessLocked(Lcom/android/server/am/ProcessRecord;ZLcom/android/server/am/ProcessRecord;)V
...
.method final finishActivityLocked(Lcom/android/server/am/ActivityRecord;ILandroid/content/Intent;Ljava/lang/String;Z)Z
    ...
    const-string v6, "finishActivityLocked-clear"

    new-instance v7, Ljava/lang/Throwable;

    const-string v8, "finishActivityLocked-clear"

    invoke-direct {v7, v8}, Ljava/lang/Throwable;-><init>(Ljava/lang/String;)V

    invoke-static {v5, v6, v7}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method final finishTopRunningActivityLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    .line 3311
    .local v9, "exce":Ljava/lang/IndexOutOfBoundsException;
    const-string v1, "ActivityManager"

    const-string v3, "finishTopRunningActivityLocked error:"

    invoke-static {v1, v3, v9}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method minimalResumeActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStackSupervisor;->checkReadyForSleepWhenResumeLocked(Landroid/content/ComponentName;)V
...
.method final moveTaskToBackLocked(I)Z
    ...
    const-string v19, "moveTaskToBack: bad taskId="
    ...
    invoke-virtual {v0, v15}, Lcom/android/server/am/ActivityStackSupervisor;->endLockTaskModeIfTaskEnding(Lcom/android/server/am/TaskRecord;)V
    ...
    .line 4439
    .local v8, "moveTopTaskInFrontStackToBack":Z
    move-object/from16 v0, p0
    ...
    .line 4440
    sget-boolean v17, Lcom/android/server/am/ActivityManagerService;->DEBUG_TASKS:Z

    if-nez v17, :cond_4

    sget-boolean v17, Lcom/android/server/am/ActivityManagerService;->DEBUG_STACK:Z
    ...
    const-string v19, "moveTaskToBackLocked:current stack is front, task prepare to move back is top task:"
    ...
    invoke-virtual {v0, v15, v1}, Lcom/android/server/am/ActivityStack;->updateTaskMovement(Lcom/android/server/am/TaskRecord;Z)V
    ...
    .line 4457
    .local v11, "numValidTasks":I
    const/16 v16, 0x0

    .line 4459
    .local v16, "validTask":Lcom/android/server/am/TaskRecord;
    ...
    const-string v19, "Single valid task "
    ...
    const-string v19, ", set over home."
    ...
    const-string v19, "moveTaskToBack:no resumed activity, check the current move back task instead. task:"
    ...
    const-string v19, "moveTaskToBack: move top task in the front stack to back, and the task has no resumed activit:"
    ...
    const-string v19, "moveTaskToBackLocked mResumedActivity : "
    ...
    const-string v19, " tr.isOverHomeStack() "
    ...
    const-string v19, "Ignore empty task "
    ...
    const-string v19, " when finding home"
    ...
    .line 4537
    .restart local v6    # "isOverHome":Z
    :cond_17
    invoke-virtual {v15}, Lcom/android/server/am/TaskRecord;->getTaskToReturnTo()I

    move-result v14

    .line 4538
    .local v14, "taskToReturnTo":I
    const/16 v17, 0x0
    ...
    invoke-virtual {v0, v14, v1}, Lcom/android/server/am/ActivityStackSupervisor;->moveNextFloatingStackToTopLocked(ILcom/android/server/am/ActivityStack;)Z
    ...
    invoke-virtual {v0, v14, v1, v2}, Lcom/android/server/am/ActivityStackSupervisor;->resumeHomeStackTask(ILcom/android/server/am/ActivityRecord;Ljava/lang/String;)Z
    ...
    .line 4559
    .end local v14    # "taskToReturnTo":I
    :cond_1c
    ...
    const-string v19, "moveTaskToBack: the current task activity:"
    ...
    const-string v19, "is not equal the mResumedActivity activity:"
...
.method public perfBoostPause()V
    ...
    const-string v1, "boostDisable(1) cross app"
    ...
    const-string v1, "perfBoostPause, PerfService is not ready!"
...
.method public perfBoostPauseDelay(I)V
    .locals 4
...
.method removeHistoryRecordsForAppLocked(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-virtual {v0, v8, v11}, Lcom/android/server/am/ActivityStack;->removeActivityFromHistoryLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)V
...
.method removeTask(Lcom/android/server/am/TaskRecord;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v8}, Lcom/mediatek/multiwindow/MultiWindowProxy;->taskRemoved(I)V
...
.method final resumeTopActivityInnerLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    invoke-direct/range {v46 .. v46}, Ljava/lang/RuntimeException;-><init>()V

    .line 1764
    .local v46, "trace":Ljava/lang/RuntimeException;
    invoke-virtual/range {v46 .. v46}, Ljava/lang/RuntimeException;->fillInStackTrace()Ljava/lang/Throwable;
    ...
    .line 1769
    .end local v46    # "trace":Ljava/lang/RuntimeException;
    :cond_6
    ...
    .line 1794
    .restart local v42    # "prevTask":Lcom/android/server/am/TaskRecord;
    :cond_9
    ...
    .line 1902
    .local v29, "focusStack":Lcom/android/server/am/ActivityStack;
    move-object/from16 v0, p0
    ...
    .line 1903
    .local v33, "lastStackBeforeResume":Lcom/android/server/am/ActivityStack;
    const/16 v30, 0x0

    .line 1904
    .local v30, "keepResume":Z
    if-eqz v29, :cond_1a
    ...
    const-string v4, "resumeTopActivityLocked: Going to sleep, and resume home from other stack, try resume one time."
    ...
    .line 1852
    .end local v29    # "focusStack":Lcom/android/server/am/ActivityStack;
    .end local v30    # "keepResume":Z
    .end local v33    # "lastStackBeforeResume":Lcom/android/server/am/ActivityStack;
    :cond_1d
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->topTask()Lcom/android/server/am/TaskRecord;
    ...
    .line 1942
    .end local v44    # "returnTaskType":I
    .restart local v29    # "focusStack":Lcom/android/server/am/ActivityStack;
    .restart local v30    # "keepResume":Z
    .restart local v33    # "lastStackBeforeResume":Lcom/android/server/am/ActivityStack;
    :cond_25
    move-object/from16 v0, p0
    ...
    .line 2098
    .local v24, "anim":Z
    sget-object v3, Lcom/android/server/am/ActivityStack;->mHyp:Lcom/oppo/hypnus/Hypnus;

    if-nez v3, :cond_3a

    .line 2099
    new-instance v3, Lcom/oppo/hypnus/Hypnus;

    invoke-direct {v3}, Lcom/oppo/hypnus/Hypnus;-><init>()V

    sput-object v3, Lcom/android/server/am/ActivityStack;->mHyp:Lcom/oppo/hypnus/Hypnus;
    ...
    .line 2194
    .local v34, "lastState":Lcom/android/server/am/ActivityStack$ActivityState;
    move-object/from16 v0, p0
    ...
    .end local v34    # "lastState":Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    sget-object v4, Lcom/android/server/am/ActivityStack;->mHyp:Lcom/oppo/hypnus/Hypnus;

    const/16 v4, 0xb

    const/16 v5, 0x258

    invoke-virtual {v3, v4, v5}, Lcom/oppo/hypnus/Hypnus;->hypnusSetAction(II)V
    ...
    .line 2216
    .restart local v31    # "lastResumedActivity":Lcom/android/server/am/ActivityRecord;
    .restart local v34    # "lastState":Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/am/ActivityStackSupervisor;->checkReadyForSleepWhenResumeLocked(Landroid/content/ComponentName;)V
...
.method final startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZZLandroid/os/Bundle;)V
    ...
    const-string v4, "WhiteBgActivity"
    ...
    const-string v4, "com.sina.weibo/.composerinde.OriginalComposerActivity"
