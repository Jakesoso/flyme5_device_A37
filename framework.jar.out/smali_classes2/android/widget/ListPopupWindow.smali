...
.field mPopup:Landroid/widget/PopupWindow;
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "JianHui.Yu@Plf.SDK, 2015-08-07 : Modify for ColorOS PopupWindow"
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v2, p0, v5}, Landroid/widget/ListPopupWindow$ResizePopupRunnable;-><init>(Landroid/widget/ListPopupWindow;Landroid/widget/ListPopupWindow$1;)V
    ...
    invoke-direct {v2, p0}, Landroid/widget/ListPopupWindow$PopupTouchInterceptor;-><init>(Landroid/widget/ListPopupWindow;)V
    ...
    invoke-direct {v2, p0, v5}, Landroid/widget/ListPopupWindow$PopupScrollListener;-><init>(Landroid/widget/ListPopupWindow;Landroid/widget/ListPopupWindow$1;)V
    ...
    invoke-direct {v2, p0, v5}, Landroid/widget/ListPopupWindow$ListSelectorHider;-><init>(Landroid/widget/ListPopupWindow;Landroid/widget/ListPopupWindow$1;)V
    ...
    .line 244
    invoke-virtual {p0, p1, p2, p3, p4}, Landroid/widget/ListPopupWindow;->createPopupWindow(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/widget/PopupWindow;
...
.method static synthetic access$500(Landroid/widget/ListPopupWindow;)Landroid/widget/ListPopupWindow$DropDownListView;
    .locals 1
    .param p0, "x0"    # Landroid/widget/ListPopupWindow;
...
.method buildDropDown()I
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->CHANGE_ACCESS:Landroid/annotation/OppoHook$OppoHookType;
        note = "JianHui.Yu@Plf.SDK, 2015-08-08 : [-private] Modify for List NavigationMode"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
...
.method public clearListSelection()V
    ...
    invoke-static {v0, v1}, Landroid/widget/ListPopupWindow$DropDownListView;->access$402(Landroid/widget/ListPopupWindow$DropDownListView;Z)Z
...
.method createPopupWindow(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/widget/PopupWindow;
    ...
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "JianHui.Yu@Plf.SDK, 2015-08-07 : Add for ColorOS PopupWindow"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    # setter for: Landroid/widget/ListPopupWindow$DropDownListView;->mListSelectionHidden:Z
    invoke-static {v9, v8}, Landroid/widget/ListPopupWindow$DropDownListView;->access$402(Landroid/widget/ListPopupWindow$DropDownListView;Z)Z
...
.method public show()V
    ...
    invoke-virtual {p0}, Landroid/widget/ListPopupWindow;->buildDropDown()I
