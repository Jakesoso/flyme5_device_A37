...
.method public blockScreenOnByFingerPrint()V
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->access$4700(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/DisplayPowerController;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/server/display/DisplayPowerController;->blockScreenOnByFingerPrint()V
...
.method public getScreenState()I
    ...
    invoke-virtual {v0}, Lcom/android/server/display/DisplayPowerController;->getScreenState()I
...
.method public initPowerManagement(Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;Landroid/os/Handler;Landroid/hardware/SensorManager;)V
    ...
    invoke-static {v1}, Lcom/android/server/display/DisplayManagerService;->access$2300(Lcom/android/server/display/DisplayManagerService;)Landroid/content/Context;
    ...
    invoke-static {v7, v0}, Lcom/android/server/display/DisplayManagerService;->access$4702(Lcom/android/server/display/DisplayManagerService;Lcom/android/server/display/DisplayPowerController;)Lcom/android/server/display/DisplayPowerController;
...
.method public isBlockScreenOnByFingerPrint()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/display/DisplayPowerController;->isBlockScreenOnByFingerPrint()Z
...
.method public notifyBootAnimationDone()V
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->access$5300(Lcom/android/server/display/DisplayManagerService;)V
...
.method public performTraversalInTransactionFromWindowManager()V
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->access$5100(Lcom/android/server/display/DisplayManagerService;)V
...
.method public setDisplayProperties(IZFZ)V
    ...
    invoke-static {v0, p1, p2, p3, p4}, Lcom/android/server/display/DisplayManagerService;->access$5200(Lcom/android/server/display/DisplayManagerService;IZFZ)V
...
.method public unblockScreenOnByFingerPrint(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/display/DisplayPowerController;->unblockScreenOnByFingerPrint(Z)V
