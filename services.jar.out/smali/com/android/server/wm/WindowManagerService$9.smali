...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;III)V
    ...
    iput p2, p0, Lcom/android/server/wm/WindowManagerService$9;->val$width:I

    iput p3, p0, Lcom/android/server/wm/WindowManagerService$9;->val$height:I

    iput p4, p0, Lcom/android/server/wm/WindowManagerService$9;->val$density:I
...
.method public run()V
    ...
    iget v1, p0, Lcom/android/server/wm/WindowManagerService$9;->val$width:I

    iget v2, p0, Lcom/android/server/wm/WindowManagerService$9;->val$height:I

    iget v3, p0, Lcom/android/server/wm/WindowManagerService$9;->val$density:I

    # invokes: Lcom/android/server/wm/WindowManagerService;->requestExtraDisplayDeviceRefreshInner(III)V
    invoke-static {v0, v1, v2, v3}, Lcom/android/server/wm/WindowManagerService;->access$2600(Lcom/android/server/wm/WindowManagerService;III)V
