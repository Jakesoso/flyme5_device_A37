...
.field protected static OEM_IMEI:[Ljava/lang/String; = null

.field private static final OEM_ISAUTO_ANSWER:Ljava/lang/String; = "oem_is_auto_answer"

.field private static final OEM_IS_NEW_VER:Ljava/lang/String; = "oem_new_ver"

.field protected static OEM_MEID:Ljava/lang/String; = null

.field public static final OEM_PRODUCT_15113:I = 0x3

.field public static final OEM_PRODUCT_15131:I = 0x1

.field public static final OEM_PRODUCT_NONE:I = 0x0

.field public static final OEM_PRODUCT_R6031:I = 0x2

.field public static final SAR_RF_STATE_DEFAULT:I = 0x0

.field public static final SAR_RF_STATE_PROXIMITY_FAR:I = 0x2

.field public static final SAR_RF_STATE_PROXIMITY_NEAR:I = 0x1
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/PhoneBase;->OEM_IMEI:[Ljava/lang/String;

    .line 3116
    const/4 v0, 0x0

    sput-object v0, Lcom/android/internal/telephony/PhoneBase;->OEM_MEID:Ljava/lang/String;

    .line 3118
    sget-boolean v0, Lcom/android/internal/telephony/OemConstant;->SWITCH_LOG:Z

    sput-boolean v0, Lcom/android/internal/telephony/PhoneBase;->DBG:Z
...
.method private privatizeCellInfoList(Ljava/util/List;)Ljava/util/List;
    ...
    .line 1474
    .end local p1    # "cellInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    ...
    .restart local p1    # "cellInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    :cond_0
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->getContext()Landroid/content/Context;
    ...
    .line 1456
    .local v13, "privateCellInfoList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/telephony/CellInfo;>;"
    ...
    new-instance v12, Landroid/telephony/CellInfoCdma;

    invoke-direct {v12, v8}, Landroid/telephony/CellInfoCdma;-><init>(Landroid/telephony/CellInfoCdma;)V

    .line 1466
    .local v12, "privateCellInfoCdma":Landroid/telephony/CellInfoCdma;
    invoke-virtual {v12, v0}, Landroid/telephony/CellInfoCdma;->setCellIdentity(Landroid/telephony/CellIdentityCdma;)V
    ...
    .end local v12    # "privateCellInfoCdma":Landroid/telephony/CellInfoCdma;
    :cond_1
    ...
    .end local v13    # "privateCellInfoList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/telephony/CellInfo;>;"
    :cond_3
    move-object v9, p1

    .line 1474
    .end local p1    # "cellInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    .restart local v9    # "cellInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    goto :goto_0
.end method
...
.method public getIccSerialNumber()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->getIccidFromProperty()Ljava/lang/String;
...
.method protected getIccidFromProperty()Ljava/lang/String;
    .locals 7
    ...
    .line 3035
    .local v0, "PROPERTY_ICCID_SIM":[Ljava/lang/String;
    const/4 v1, 0x0
    ...
    const-string v5, "getIccidFromProperty, subId:"
    ...
    const-string v5, "getIccidFromProperty, result:"
...
.method public getLteCdmaImsi(I)[Ljava/lang/String;
    ...
    .line 3101
    sget-boolean v5, Lcom/android/internal/telephony/PhoneBase;->DBG:Z
...
.method public getOemAutoAnswer()Z
    .locals 13
    ...
    invoke-static {v8}, Lcom/android/internal/telephony/OemConstant;->isCTA(Landroid/content/Context;)Z
    ...
    const-string v11, "oem_is_auto_answer"
    ...
    .line 3159
    sget-boolean v8, Lcom/android/internal/telephony/PhoneBase;->DBG:Z
    ...
    const-string v12, "getOemAutoAnswer isnew:"
    ...
    .line 3175
    .end local v3    # "isauto":Z
    .local v4, "isauto":Z
    :goto_1
    return v4

    .end local v4    # "isauto":Z
    .restart local v3    # "isauto":Z
    :cond_1
    move v8, v10
    ...
    invoke-virtual {v8, v11, v12}, Landroid/content/Context;->createPackageContext(Ljava/lang/String;I)Landroid/content/Context;

    move-result-object v2

    .line 3166
    .local v2, "friendContext":Landroid/content/Context;
    ...
    .line 3173
    .end local v2    # "friendContext":Landroid/content/Context;
    ...
    const-string v10, "old getOemAutoAnswer isauto:"
    ...
    .end local v4    # "isauto":Z
    .restart local v2    # "friendContext":Landroid/content/Context;
    .restart local v3    # "isauto":Z
    .restart local v6    # "sh":Landroid/content/SharedPreferences;
    :cond_5
    move v9, v10
    ...
    const-string v10, "getOemAutoAnswer ex= "
...
.method public oemGetTxPowerBackoffIndex()I
    .locals 4
    ...
    .line 3238
    .local v2, "sarPowerBbackoffIndex":I
    const-string v3, "oppo6750_15131"
    ...
    .line 3242
    :cond_3
    const-string v3, "oppo6755_15111"
...
.method public oemMigrate(Landroid/os/RegistrantList;Landroid/os/RegistrantList;)V
    ...
    .line 3203
    .local v5, "r":Landroid/os/Registrant;
    const/4 v1, 0x0
    ...
    .line 3206
    .local v6, "rto":Landroid/os/Registrant;
    if-ne v6, v5, :cond_2
    ...
    .line 3211
    .end local v6    # "rto":Landroid/os/Registrant;
    :cond_0
    ...
    const-string v9, "leon oemMigrate:"
    ...
    invoke-virtual {p1, v5}, Landroid/os/RegistrantList;->add(Landroid/os/Registrant;)V
    ...
    .line 3204
    .restart local v6    # "rto":Landroid/os/Registrant;
    :cond_2
    add-int/lit8 v2, v2, 0x1
    ...
    .end local v2    # "j":I
    .end local v3    # "k":I
    .end local v5    # "r":Landroid/os/Registrant;
    .end local v6    # "rto":Landroid/os/Registrant;
    :cond_3
    return-void
.end method
...
.method public oemMigrateFrom()V
    ...
    iget-object v1, v1, Lcom/android/internal/telephony/imsphone/ImsPhone;->mHandoverRegistrants:Landroid/os/RegistrantList;

    invoke-virtual {p0, v0, v1}, Lcom/android/internal/telephony/PhoneBase;->oemMigrate(Landroid/os/RegistrantList;Landroid/os/RegistrantList;)V
...
.method protected saveImeiAndMeid(Ljava/lang/String;Ljava/lang/String;)V
    .locals 4
    .param p1, "mMeid"    # Ljava/lang/String;
    .param p2, "mImei"    # Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/internal/telephony/PhoneBase;->OEM_MEID:Ljava/lang/String;
    ...
    .line 3125
    sput-object p1, Lcom/android/internal/telephony/PhoneBase;->OEM_MEID:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/internal/telephony/PhoneBase;->OEM_IMEI:[Ljava/lang/String;
    ...
    .line 3133
    :cond_1
    sget-boolean v1, Lcom/android/internal/telephony/PhoneBase;->DBG:Z
    ...
    const-string v3, "saveImeiAndMeid:"
    ...
    sget-object v3, Lcom/android/internal/telephony/PhoneBase;->OEM_MEID:Ljava/lang/String;
    ...
    sget-object v3, Lcom/android/internal/telephony/PhoneBase;->OEM_IMEI:[Ljava/lang/String;
...
.method public setOemAutoAnswer(Z)V
    .locals 4
    .param p1, "isauto"    # Z
    ...
    .line 3181
    .local v0, "editor":Landroid/content/SharedPreferences$Editor;
    const-string v2, "oem_is_auto_answer"

    invoke-interface {v0, v2, p1}, Landroid/content/SharedPreferences$Editor;->putBoolean(Ljava/lang/String;Z)Landroid/content/SharedPreferences$Editor;

    .line 3182
    const-string v2, "oem_new_ver"
