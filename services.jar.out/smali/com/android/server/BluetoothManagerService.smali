...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 140
    iput-boolean v5, p0, Lcom/android/server/BluetoothManagerService;->mChipReset:Z

    .line 157
    iput-boolean v5, p0, Lcom/android/server/BluetoothManagerService;->mQuietEnable:Z

    .line 173
    iput-object v6, p0, Lcom/android/server/BluetoothManagerService;->mHyp:Lcom/oppo/hypnus/Hypnus;
...
.method static synthetic access$1400(Lcom/android/server/BluetoothManagerService;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$4202(Lcom/android/server/BluetoothManagerService;Z)Z
    ...
    .prologue
    .line 77
    iput-boolean p1, p0, Lcom/android/server/BluetoothManagerService;->mChipReset:Z
...
.method private bluetoothStateChangeHandler(II)V
    ...
    .line 1733
    iget-boolean v3, p0, Lcom/android/server/BluetoothManagerService;->mChipReset:Z
...
.method private sendBluetoothServiceDownCallback()V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/BluetoothManagerService;->tryResumeProcess(I)Z
    ...
    const-string v6, "sendBluetoothServiceDownCallback() resume failed, don\'t call back!!! i = "
...
.method private sendBluetoothServiceUpCallback()V
    ...
    const-string v6, "sendBluetoothServiceUpCallback() resume failed, don\'t call back!!! i = "
...
.method private sendBluetoothStateCallback(Z)V
    ...
    const-string v6, "Broadcasting onBluetoothStateChange("
    ...
    invoke-interface {v4, p1}, Landroid/bluetooth/IBluetoothStateChangeCallback;->onBluetoothStateChange(Z)V
    ...
    const-string v6, "sendBluetoothStateCallback() resume failed, don\'t call back!!! i = "
    ...
    const-string v6, "Unable to call onBluetoothStateChange() on callback #"
...
.method private sendEnableMsg(Z)V
    ...
    .line 1793
    iget-boolean v0, p0, Lcom/android/server/BluetoothManagerService;->mChipReset:Z
    ...
    .line 1796
    iput-boolean v2, p0, Lcom/android/server/BluetoothManagerService;->mChipReset:Z
...
.method private tryResumeProcess(I)Z
    ...
    const-string v5, "tryResumeProcess return true pid = "
...
.method public enable()Z
    ...
    .line 538
    :cond_1
    iget-object v2, p0, Lcom/android/server/BluetoothManagerService;->mHyp:Lcom/oppo/hypnus/Hypnus;

    if-nez v2, :cond_2

    .line 539
    new-instance v2, Lcom/oppo/hypnus/Hypnus;

    invoke-direct {v2}, Lcom/oppo/hypnus/Hypnus;-><init>()V

    iput-object v2, p0, Lcom/android/server/BluetoothManagerService;->mHyp:Lcom/oppo/hypnus/Hypnus;
    ...
    invoke-virtual {v2, v4, v5}, Lcom/oppo/hypnus/Hypnus;->hypnusSetAction(II)V
