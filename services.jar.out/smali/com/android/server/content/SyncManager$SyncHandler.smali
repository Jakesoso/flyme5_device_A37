...
.method private dispatchSyncOperation(Lcom/android/server/content/SyncOperation;)Z
    ...
    .line 2813
    .local v12, "syncContext":Lcom/android/server/content/SyncManager$ActiveSyncContext;
    const-string v2, "SyncManager"

    invoke-virtual {v12}, Lcom/android/server/content/SyncManager$ActiveSyncContext;->toString()Ljava/lang/String;
    ...
    .end local v12    # "syncContext":Lcom/android/server/content/SyncManager$ActiveSyncContext;
    :cond_0
    ...
    invoke-virtual {v2, v11, v3}, Landroid/content/SyncAdaptersCache;->getServiceInfo(Ljava/lang/Object;I)Landroid/content/pm/RegisteredServicesCache$ServiceInfo;

    move-result-object v10

    .line 2825
    .local v10, "syncAdapterInfo":Landroid/content/pm/RegisteredServicesCache$ServiceInfo;, "Landroid/content/pm/RegisteredServicesCache$ServiceInfo<Landroid/content/SyncAdapterType;>;"
    if-nez v10, :cond_1
    ...
    .line 2891
    .end local v10    # "syncAdapterInfo":Landroid/content/pm/RegisteredServicesCache$ServiceInfo;, "Landroid/content/pm/RegisteredServicesCache$ServiceInfo<Landroid/content/SyncAdapterType;>;"
    .end local v11    # "syncAdapterType":Landroid/content/SyncAdapterType;
    :goto_1
    return v2

    .line 2831
    .restart local v10    # "syncAdapterInfo":Landroid/content/pm/RegisteredServicesCache$ServiceInfo;, "Landroid/content/pm/RegisteredServicesCache$ServiceInfo<Landroid/content/SyncAdapterType;>;"
    .restart local v11    # "syncAdapterType":Landroid/content/SyncAdapterType;
    :cond_1
    iget v6, v10, Landroid/content/pm/RegisteredServicesCache$ServiceInfo;->uid:I

    .line 2832
    .local v6, "targetUid":I
    iget-object v13, v10, Landroid/content/pm/RegisteredServicesCache$ServiceInfo;->componentName:Landroid/content/ComponentName;
    ...
    invoke-virtual {v2, v9}, Lcom/android/server/am/OppoAbnormalAppManager;->isScreenOffRestrictApp(Ljava/lang/String;)Z
    ...
    const-string v4, "dispatchSyncOperation: pkg{"
    ...
    const-string v4, "} is screen off Restrict App, skip sync!!!"
    ...
    .end local v13    # "targetComponent":Landroid/content/ComponentName;
    :cond_2
    :try_start_0
    iget-object v2, p0, Lcom/android/server/content/SyncManager$SyncHandler;->this$0:Lcom/android/server/content/SyncManager;
    ...
    iget-object v13, v8, Lcom/android/server/content/SyncStorageEngine$EndPoint;->service:Landroid/content/ComponentName;
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    .restart local v13    # "targetComponent":Landroid/content/ComponentName;
    goto :goto_2
