...
.method private doDeferEnable(Landroid/os/Message;)Z
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiController;->access$2800(Lcom/android/server/wifi/WifiController;)J
    ...
    # getter for: Lcom/android/server/wifi/WifiController;->mReEnableDelayMillis:J
    invoke-static {v5}, Lcom/android/server/wifi/WifiController;->access$2800(Lcom/android/server/wifi/WifiController;)J
    ...
    invoke-static {v1, v4}, Lcom/android/server/wifi/WifiController;->access$5300(Lcom/android/server/wifi/WifiController;Ljava/lang/String;)V

    .line 766
    iget-object v1, p0, Lcom/android/server/wifi/WifiController$StaDisabledWithScanState;->this$0:Lcom/android/server/wifi/WifiController;

    # invokes: Lcom/android/server/wifi/WifiController;->removeMessages(I)V
    invoke-static {v1, v8}, Lcom/android/server/wifi/WifiController;->access$5400(Lcom/android/server/wifi/WifiController;I)V

    .line 768
    iget-object v1, p0, Lcom/android/server/wifi/WifiController$StaDisabledWithScanState;->this$0:Lcom/android/server/wifi/WifiController;

    invoke-virtual {v1, v8}, Lcom/android/server/wifi/WifiController;->obtainMessage(I)Landroid/os/Message;
    ...
    # getter for: Lcom/android/server/wifi/WifiController;->mReEnableDelayMillis:J
    invoke-static {v4}, Lcom/android/server/wifi/WifiController;->access$2800(Lcom/android/server/wifi/WifiController;)J
...
.method public enter()V
    ...
    # invokes: Lcom/android/server/wifi/WifiController;->log(Ljava/lang/String;)V
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiController;->access$4200(Lcom/android/server/wifi/WifiController;Ljava/lang/String;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v3, v0}, Lcom/android/server/wifi/WifiController;->access$1602(Lcom/android/server/wifi/WifiController;Z)Z
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiController;->access$3200(Lcom/android/server/wifi/WifiController;)Lcom/android/server/wifi/WifiController$ApStaDisabledState;
    ...
    const-string v4, "Have removed previous Message CMD_DEFERRED_TOGGLE"
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiController;->access$700(Lcom/android/server/wifi/WifiController;)Z
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiController;->access$1700(Lcom/android/server/wifi/WifiController;)Lcom/android/server/wifi/WifiController$DeviceActiveState;
    ...
    # getter for: Lcom/android/server/wifi/WifiController;->mShouldIgnoreCmdSetAp:Z
    invoke-static {v3}, Lcom/android/server/wifi/WifiController;->access$2300(Lcom/android/server/wifi/WifiController;)Z
    ...
    const-string v4, "ignore CMD_SET_AP: 155658"
    ...
    invoke-static {v3, v1}, Lcom/android/server/wifi/WifiController;->access$2302(Lcom/android/server/wifi/WifiController;Z)Z
    ...
    invoke-static {v1, p1}, Lcom/android/server/wifi/WifiController;->access$4900(Lcom/android/server/wifi/WifiController;Landroid/os/Message;)V
    ...
    # invokes: Lcom/android/server/wifi/WifiController;->log(Ljava/lang/String;)V
    invoke-static {v1, v3}, Lcom/android/server/wifi/WifiController;->access$5100(Lcom/android/server/wifi/WifiController;Ljava/lang/String;)V
    ...
    invoke-static {v1, v3}, Lcom/android/server/wifi/WifiController;->access$5200(Lcom/android/server/wifi/WifiController;Ljava/lang/String;)V
