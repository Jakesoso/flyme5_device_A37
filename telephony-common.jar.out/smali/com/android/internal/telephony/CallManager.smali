...
.method static synthetic access$100(Lcom/android/internal/telephony/CallManager;Lcom/android/internal/telephony/Connection;)V
    .locals 0
...
.method static synthetic access$300(Lcom/android/internal/telephony/CallManager;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/internal/telephony/CallManager;
...
.method static synthetic access$302(Lcom/android/internal/telephony/CallManager;J)J
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/CallManager;
    .param p1, "x1"    # J
...
.method private writeCallRecord(Lcom/android/internal/telephony/Connection;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/CallManager;->getCurrentDateStr()Ljava/lang/String;
    ...
    const-string v17, "writeCallRecord address = "
    ...
    iget-object v15, v0, Lcom/android/internal/telephony/CallManager;->mOppoUsageManager:Landroid/os/OppoUsageManager;

    long-to-int v0, v4

    move/from16 v16, v0

    invoke-virtual/range {v15 .. v16}, Landroid/os/OppoUsageManager;->accumulateInComingCallDuration(I)Z
    ...
    .line 2539
    .local v14, "log_type":I
    const-string v12, ""
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 2541
    .local v12, "log_desc":Ljava/lang/String;
    :try_start_1
    ...
    const-string v17, "zz_oppo_critical_log_10"
    ...
    .line 2542
    .local v13, "log_string":Ljava/lang/String;
    const-string v15, ","
    ...
    .line 2543
    .local v11, "log_array":[Ljava/lang/String;
    const/4 v15, 0x0
    ...
    .line 2549
    .end local v11    # "log_array":[Ljava/lang/String;
    .end local v13    # "log_string":Ljava/lang/String;
    :goto_2
    :try_start_2
    invoke-virtual/range {p1 .. p1}, Lcom/android/internal/telephony/Connection;->getDisconnectCause()I
    ...
    const-string v16, "call drop cause:"
    ...
    const-string v17, "mo_drop"

    move-object/from16 v0, v16

    move-object/from16 v1, v17

    invoke-static {v14, v15, v0, v1, v12}, Landroid/os/OppoManager;->writeLogToPartition(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I

    .line 2557
    :cond_1
    move-object/from16 v0, p0

    invoke-direct {v0, v2, v10}, Lcom/android/internal/telephony/CallManager;->dealWithAddress(Ljava/lang/String;Z)Ljava/lang/String;

    move-result-object v3

    .line 2558
    .local v3, "addressInfo":Ljava/lang/String;
    if-eqz v3, :cond_2
    ...
    .line 2568
    .end local v3    # "addressInfo":Ljava/lang/String;
    .end local v6    # "cause":I
    .end local v12    # "log_desc":Ljava/lang/String;
    .end local v14    # "log_type":I
    :cond_2
    :goto_3
    return-void
    ...
    invoke-virtual/range {v15 .. v16}, Landroid/os/OppoUsageManager;->accumulateDialOutDuration(I)Z
    ...
    .line 2562
    .restart local v3    # "addressInfo":Ljava/lang/String;
    .restart local v6    # "cause":I
    .restart local v12    # "log_desc":Ljava/lang/String;
    .restart local v14    # "log_type":I
    :cond_5
    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/internal/telephony/CallManager;->mOppoUsageManager:Landroid/os/OppoUsageManager;

    invoke-virtual {v15, v3, v7}, Landroid/os/OppoUsageManager;->writePhoneCallHistoryRecord(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_3
