...
.method static synthetic access$1000(Lcom/android/server/notification/DowntimeConditionProvider;)V
    .locals 0
...
.method static synthetic access$1100(Lcom/android/server/notification/DowntimeConditionProvider;Landroid/app/AlarmManager$AlarmClockInfo;JZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
...
.method static synthetic access$1200(Lcom/android/server/notification/DowntimeConditionProvider;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
...
.method static synthetic access$1202(Lcom/android/server/notification/DowntimeConditionProvider;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
    .param p1, "x1"    # Z
...
.method static synthetic access$1300(Lcom/android/server/notification/DowntimeConditionProvider;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
...
.method static synthetic access$1400(Lcom/android/server/notification/DowntimeConditionProvider;)Lcom/android/server/notification/NextAlarmTracker;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
...
.method static synthetic access$300(Lcom/android/server/notification/DowntimeConditionProvider;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
...
.method static synthetic access$502(Lcom/android/server/notification/DowntimeConditionProvider;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
    .param p1, "x1"    # Z
...
.method static synthetic access$600(Lcom/android/server/notification/DowntimeConditionProvider;)Lcom/android/server/notification/ZenModeHelper;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
...
.method static synthetic access$700(Lcom/android/server/notification/DowntimeConditionProvider;)Lcom/android/server/notification/DowntimeConditionProvider$FiredAlarms;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
...
.method static synthetic access$800(Lcom/android/server/notification/DowntimeConditionProvider;)Lcom/android/server/notification/DowntimeCalendar;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
...
.method static synthetic access$900(Lcom/android/server/notification/DowntimeConditionProvider;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/DowntimeConditionProvider;
...
.method private evaluateAutotrigger()V
    ...
    const-string v4, "Autotrigger skipped: "
    ...
    invoke-static {v3}, Lcom/android/server/notification/ZenLog;->traceDowntimeAutotrigger(Ljava/lang/String;)V
    ...
    .line 328
    :cond_1
    iget-boolean v3, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mDowntimed:Z
    ...
    .line 330
    :cond_2
    iget-object v3, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mZenModeHelper:Lcom/android/server/notification/ZenModeHelper;
    ...
    .line 332
    :cond_3
    iget-object v3, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mCalendar:Lcom/android/server/notification/DowntimeCalendar;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7}, Lcom/android/server/notification/DowntimeCalendar;->isInDowntime(J)Z
    ...
    .line 339
    :cond_4
    const-string v3, "Autotrigger fired"

    invoke-static {v3}, Lcom/android/server/notification/ZenLog;->traceDowntimeAutotrigger(Ljava/lang/String;)V

    .line 340
    iget-object v5, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mZenModeHelper:Lcom/android/server/notification/ZenModeHelper;
    ...
    invoke-virtual {v5, v3, v6}, Lcom/android/server/notification/ZenModeHelper;->setZenMode(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/notification/DowntimeConditionProvider;->createCondition(Landroid/service/notification/ZenModeConfig$DowntimeInfo;I)Landroid/service/notification/Condition;

    move-result-object v0

    .line 343
    .local v0, "condition":Landroid/service/notification/Condition;
    iget-object v3, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mConditionProviders:Lcom/android/server/notification/ConditionProviders;

    const-string v5, "downtime"

    invoke-virtual {v3, v0, v5}, Lcom/android/server/notification/ConditionProviders;->setZenModeCondition(Landroid/service/notification/Condition;Ljava/lang/String;)V

    .line 346
    const-string v3, "DowntimeConditions"

    const-string v5, "Enter zen: automatic condition true: "

    invoke-static {v3, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 347
    iget-object v3, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mContext:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v3

    const-string v5, "systemui_auto_enter_important_interruptions"
    ...
    const-string v5, "systemui_important_interruptions"
    ...
    const-string v4, "systemui_important_interruptions"
    ...
    const-string v5, "Enter zen: automatic condition true: state = "
...
.method public onConnected()V
    ...
    iput-boolean v2, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mConnected:Z

    .line 119
    iget-object v2, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mContext:Landroid/content/Context;

    const-string v3, "downtime.condition.lookahead"

    const v4, 0x10e007e

    invoke-static {v2, v3, v4}, Lcom/android/server/notification/PropConfig;->getInt(Landroid/content/Context;Ljava/lang/String;I)I
    ...
    const-string v2, "DowntimeConditions.enter"

    invoke-virtual {v1, v2}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 123
    const-string v2, "DowntimeConditions.exit"
    ...
    iget-object v3, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v3, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mTrackerCallback:Lcom/android/server/notification/NextAlarmTracker$Callback;

    invoke-virtual {v2, v3}, Lcom/android/server/notification/NextAlarmTracker;->addCallback(Lcom/android/server/notification/NextAlarmTracker$Callback;)V
    ...
    iget-object v3, p0, Lcom/android/server/notification/DowntimeConditionProvider;->mZenCallback:Lcom/android/server/notification/ZenModeHelper$Callback;
    ...
    const-string v3, "systemui_auto_interruptions"
    ...
    const-string v4, "init_autoToggle = "
