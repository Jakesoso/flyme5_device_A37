...
.field private mKeyNormalColor:I
...
.field private mPressedColor:Landroid/content/res/ColorStateList;
...
.field private mSpecialColor:Landroid/content/res/ColorStateList;
...
.field private mTransParentBg:Landroid/graphics/drawable/Drawable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "Suying.You@Plf.SDK : Add for 3.0"
    ...
    iput-object v11, v0, Landroid/inputmethodservice/KeyboardView;->mTransParentBg:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v11, v0, Landroid/inputmethodservice/KeyboardView;->mPressedColor:Landroid/content/res/ColorStateList;
    ...
    iput v11, v0, Landroid/inputmethodservice/KeyboardView;->mBgWidth:I
    ...
    iput v11, v0, Landroid/inputmethodservice/KeyboardView;->mBgHeight:I
    ...
    iput-object v11, v0, Landroid/inputmethodservice/KeyboardView;->mSpecialColor:Landroid/content/res/ColorStateList;
    ...
    .line 414
    invoke-virtual/range {p0 .. p0}, Landroid/inputmethodservice/KeyboardView;->getContext()Landroid/content/Context;

    move-result-object v11

    invoke-static {v11}, Lcom/color/util/ColorContextUtil;->isOppoStyle(Landroid/content/Context;)Z
    ...
    iput v11, v0, Landroid/inputmethodservice/KeyboardView;->mBgColor:I
    ...
    iput v11, v0, Landroid/inputmethodservice/KeyboardView;->mKeyNormalColor:I

    .line 420
    move-object/from16 v0, p0

    iget-object v11, v0, Landroid/inputmethodservice/KeyboardView;->mTransParentBg:Landroid/graphics/drawable/Drawable;
...
.method private detectAndSendKey(IIIJ)V
    ...
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "Suying.You@Plf.SDK : Modify for delete the c code"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
    ...
    invoke-static {v3}, Lcom/color/util/ColorContextUtil;->isOppoStyle(Landroid/content/Context;)Z
...
.method private onBufferDraw()V
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->CHANGE_CODE:Landroid/annotation/OppoHook$OppoHookType;
        note = "Suying.You@Plf.SDK : Modify for the new GUI of the 3.0"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
    ...
    iput-object v4, v0, Landroid/inputmethodservice/KeyboardView;->mBuffer:Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Landroid/inputmethodservice/KeyboardView;->mBuffer:Landroid/graphics/Bitmap;

    invoke-direct {v4, v5}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V

    move-object/from16 v0, p0

    iput-object v4, v0, Landroid/inputmethodservice/KeyboardView;->mCanvas:Landroid/graphics/Canvas;
    ...
    iput-boolean v4, v0, Landroid/inputmethodservice/KeyboardView;->mKeyboardChanged:Z

    .line 718
    :cond_3
    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/inputmethodservice/KeyboardView;->mCanvas:Landroid/graphics/Canvas;
    ...
    invoke-virtual {v3, v4, v5}, Landroid/graphics/Canvas;->clipRect(Landroid/graphics/Rect;Landroid/graphics/Region$Op;)Z

    .line 721
    move-object/from16 v0, p0

    iget-object v4, v0, Landroid/inputmethodservice/KeyboardView;->mKeyboard:Landroid/inputmethodservice/Keyboard;
    ...
    iget-object v8, v0, Landroid/inputmethodservice/KeyboardView;->mPaint:Landroid/graphics/Paint;
    ...
    iget-object v11, v0, Landroid/inputmethodservice/KeyboardView;->mClipRegion:Landroid/graphics/Rect;
    ...
    .line 734
    .local v12, "drawSingleKey":Z
    if-eqz v18, :cond_5

    invoke-virtual {v3, v11}, Landroid/graphics/Canvas;->getClipBounds(Landroid/graphics/Rect;)Z
    ...
    invoke-static {v4}, Lcom/color/util/ColorContextUtil;->isOppoStyle(Landroid/content/Context;)Z
    ...
    invoke-virtual {v3, v0, v1, v2, v9}, Landroid/graphics/Canvas;->clipRect(IIII)Z
    ...
    iget-object v4, v0, Landroid/inputmethodservice/KeyboardView;->mPressedColor:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v13, v5}, Landroid/content/res/ColorStateList;->getColorForState([II)I
    ...
    iget-object v4, v0, Landroid/inputmethodservice/KeyboardView;->mSpecialColor:Landroid/content/res/ColorStateList;
    ...
    iget v4, v0, Landroid/inputmethodservice/KeyboardView;->mKeyNormalColor:I
    ...
    invoke-virtual {v0, v13}, Landroid/graphics/drawable/Drawable;->setState([I)Z
    ...
    iget v4, v0, Landroid/inputmethodservice/KeyboardView;->mLabelTextSize:I
    ...
    iget v4, v0, Landroid/inputmethodservice/KeyboardView;->mShadowRadius:F
    ...
    invoke-virtual {v8, v4, v5, v6, v7}, Landroid/graphics/Paint;->setShadowLayer(FFFI)V
    ...
    invoke-virtual {v3, v0, v4, v5, v8}, Landroid/graphics/Canvas;->drawText(Ljava/lang/String;FFLandroid/graphics/Paint;)V
    ...
    invoke-direct {v0, v4}, Landroid/inputmethodservice/KeyboardView;->adjustCase(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    iget v4, v0, Landroid/inputmethodservice/KeyboardView;->mKeyTextSize:I
    ...
    invoke-virtual {v4, v5, v6, v7, v0}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    .end local v14    # "drawableX":I
    .end local v15    # "drawableY":I
    ...
    iput-object v4, v0, Landroid/inputmethodservice/KeyboardView;->mInvalidatedKey:Landroid/inputmethodservice/Keyboard$Key;

    .line 835
    move-object/from16 v0, p0

    iget-boolean v4, v0, Landroid/inputmethodservice/KeyboardView;->mMiniKeyboardOnScreen:Z
    ...
    iget v4, v0, Landroid/inputmethodservice/KeyboardView;->mBackgroundDimAmount:F
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->CHANGE_CODE:Landroid/annotation/OppoHook$OppoHookType;
        note = "Suying.You@Plf.SDK : Modify for 3.0"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
    ...
    .line 685
    iget v0, p0, Landroid/inputmethodservice/KeyboardView;->mBgWidth:I

    iget v1, p0, Landroid/inputmethodservice/KeyboardView;->mBgHeight:I

    invoke-virtual {p1, v3, v3, v0, v1}, Landroid/graphics/Canvas;->clipRect(IIII)Z

    .line 686
    iget v0, p0, Landroid/inputmethodservice/KeyboardView;->mBgColor:I
    ...
    iget-object v0, p0, Landroid/inputmethodservice/KeyboardView;->mTransParentBg:Landroid/graphics/drawable/Drawable;
    ...
    iget v1, p0, Landroid/inputmethodservice/KeyboardView;->mBgWidth:I

    iget v2, p0, Landroid/inputmethodservice/KeyboardView;->mBgHeight:I
